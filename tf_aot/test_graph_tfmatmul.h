...
#ifndef TFCOMPILE_GENERATED___tensorflow_compiler_aot_tests_experiment__test_graph_tfmatmul_H_  // NOLINT(build/header_guard)
#define TFCOMPILE_GENERATED___tensorflow_compiler_aot_tests_experiment__test_graph_tfmatmul_H_  // NOLINT(build/header_guard)
...
extern "C" void __tensorflow_compiler_aot_tests_experiment__test_graph_tfmatmul(
...
class MatMulComp : public tensorflow::XlaCompiledCpuFunction {
 public:
  ...
  static const tensorflow::XlaCompiledCpuFunction::StaticData& StaticData() {
    static XlaCompiledCpuFunction::StaticData* kStaticData = [](){
      ...
      data->set_raw_function(__tensorflow_compiler_aot_tests_experiment__test_graph_tfmatmul);
  ...
  MatMulComp(AllocMode alloc_mode = AllocMode::ARGS_RESULTS_PROFILES_AND_TEMPS)
      : XlaCompiledCpuFunction(StaticData(), alloc_mode) {}

  MatMulComp(const MatMulComp&) = delete;
  MatMulComp& operator=(const MatMulComp&) = delete;
  ...
  const float& arg0(size_t dim0, size_t dim1) const {
    return (*static_cast<const float(*)[2][3]>(
        arg_data(0)))[dim0][dim1];
  }
  ...
  const float& arg1(size_t dim0, size_t dim1) const {
    return (*static_cast<const float(*)[3][2]>(
        arg_data(1)))[dim0][dim1];
  }
...
::tensorflow::cpu_function_runtime::BufferInfo({98ULL, 0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({98ULL, 1ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({65ULL, ~0ULL}),
::tensorflow::cpu_function_runtime::BufferInfo({33ULL, ~0ULL})
      };
    return kBufferInfos;
  }
...
0, 1
  ...
  static constexpr size_t kResultIndex = 3;
...
#endif  // TFCOMPILE_GENERATED___tensorflow_compiler_aot_tests_experiment__test_graph_tfmatmul_H_
